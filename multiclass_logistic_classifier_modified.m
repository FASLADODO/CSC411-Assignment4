function [ predictions ] = multiclass_logistic_classifier_modified( validationParam, tr_images, tr_labels, public_test_images)
...
%provided, then predicts for the test data provided
    ...
    % Removed for use with Gabor Energy Filters - no need for reshape,
    ...
    training_data = tr_images/1000;
    test_data = public_test_images/1000;
