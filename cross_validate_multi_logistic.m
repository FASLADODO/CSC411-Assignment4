...
function mean_acc = cross_validate_multi_logistic(K, tr_images, tr_labels, nfold, tr_identity)
...
for i=1:nfold
  ...
  predi = multiclass_logistic_classifier(K, tr_images(:, :, traini_ids), tr_labels(traini_ids), tr_images(:, :, testi_ids));
